...
%%TODO include the PDF only if for printing
%%\includepdf{attachments/prohlaseni_autora_skolniho_dila_v3.pdf}

%%TODO Thanks (optional)
\begin{ThesisThanks}
Chtěl bych obzvláště poděkovat Ing. Leonardu Walletzkému, Ph.D za příležitost pracovat na tomto projektu a za maximální podporu při jeho vypracování. %TODO doplnit
Šedové za konzultace a podporu při vývoji. Děkuji všem svým spolupracovníkům za ohleduplnost a trpělivost nutnou s ohledem na ztížené podmínky, které byly způsobeny mou prací ze zahraničí. Speciálně Ondrovi Maternovi za návrh celého řešení, Ivaně Haraslínové za design a jeho aplikaci a Radkovi %TODO doplnit
