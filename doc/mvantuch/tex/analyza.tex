...
Phing povoluje vývoj vlastních operací (task), čehož tento projekt využívá. Za pomoci příkazu TaskdefTask~\cite{website:phing-taskdef} je definovaná operace <drush> poskytující rozhraní k programu Drush. Tím je umožněno automatizovat většinu administrátorských operací nad projektem a případně implementovat automatickou analýzu kódu a testování pomocí \gls{ci}.
...
\begin{itemize}
  ...
  \item \textbf{phing/} \hfill \\
    soubory určené k podpoře %% TODO \gls{deployment} 
